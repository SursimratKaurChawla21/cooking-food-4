      ...
      if(frameCount % 60 === 0) {
        ...
        switch(rand) {
          case 1: ingredients.addImage(canolaoil);
                  ...
                  break;
          case 2: ingredients.addImage();
                  ingredients.scale=0.01
                  break;
          case 3: ingredients.addImage(cloves);
                  break;
          case 4: ingredients.addImage(butter);
                  break;
          case 5: ingredients.addImage(cardomom);
                  break;
          case 6: ingredients.addImage(onions);
                  ingredients.scale=0.1
                  break;
          case 7: ingredients.addImage(ginger);
                  ingredients.scale=0.01
                  break;
          case 8: ingredients.addImage(tomato);
                  break;
          case 9: ingredients.addImage(cashew);
                  break;
          case 10: ingredients.addImage(bayleaf);
          ingredients.scale=0.1
                  break;
                  case 1: ingredients.addImage(chilli);
                  ingredients.scale=0.01
                  break;
          case 11: ingredients.addImage(turmeric);
                  ingredients.scale=0.01
                  break;
          case 12: ingredients.addImage(coriander);
                  break;
          case 13: ingredients.addImage(cuminpowder);
                  break;
          case 14: ingredients.addImage(salt);
                  break;
          case 15: ingredients.addImage(boilingwater);
                  ingredients.scale=0.1
                  break;
          case 16: ingredients.addImage(sourcream);
                  ingredients.scale=0.01
                  break;
          case 17: ingredients.addImage(cheddarcheese);
                  break;
          case 18: ingredients.addImage(kasurimethi);
                  break;
